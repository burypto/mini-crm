...
Bu bölüm, projenin profesyonel bir sürüm kontrol sistemi (Git) ve ekip içi kod inceleme (Code Review) süreçlerinden geçtiğini belgelemektedir. Code Review **"Salih Kızılkaya"** ile yapılmıştır.
